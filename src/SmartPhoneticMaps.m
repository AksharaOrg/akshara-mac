...
+ (NSDictionary<NSString *, NSString *> *)smartVowels {
  ...
  dispatch_once(&onceToken, ^{
    map = @{
      ...
      @"A": @"ඇ", @"Aa": @"ඈ", @"AA": @"ඈ",
      @"i": @"ඉ", @"ii": @"ඊ", @"I": @"ඊ",
      @"u": @"උ", @"uu": @"ඌ", @"U": @"උ", @"UU": @"ඌ", @"Uu": @"ඌ",
      @"R": @"ඍ", @"Ru": @"ඎ",
      @"e": @"එ", @"ee": @"ඒ", @"E": @"ඓ",
      @"ai": @"ඓ",
      @"o": @"ඔ", @"oo": @"ඕ", @"O": @"ඔ", @"OO": @"ඕ", @"Oo": @"ඕ",
      @"au": @"ඖ", @"ou": @"ඖ"
    };
  });
  return map;
...
+ (NSDictionary<NSString *, NSString *> *)smartVowelSigns {
  ...
  dispatch_once(&onceToken, ^{
    map = @{
      ...
      @"A": @"ැ", @"Aa": @"ෑ", @"AA": @"ෑ",
      @"i": @"ි", @"ii": @"ී", @"I": @"ී",
      @"u": @"ු", @"uu": @"ූ", @"U": @"ු", @"UU": @"ූ", @"Uu": @"ූ",
      @"e": @"ෙ", @"ee": @"ේ", @"E": @"ෛ",
      @"ai": @"ෛ",
      @"o": @"ො", @"oo": @"ෝ", @"O": @"ො", @"OO": @"ෝ", @"Oo": @"ෝ",
      @"au": @"ෞ", @"ou": @"ෞ",
      @"ru": @"ෘ", @"ruu": @"ෲ"
    };
  });
...
+ (NSArray<NSString *> *)smartConsonantKeys {
  return @[@"chh", @"thh", @"dhh", @"zdh",
           ...
           @"zg", @"zj", @"zd", @"zq", @"zk", @"zh",
           @"k", @"g", @"c", @"j", @"t", @"d", @"q", @"n", @"N", @"p", @"b", @"m",
           @"y", @"r", @"l", @"L", @"w", @"v", @"s", @"S", @"h", @"f",
           @"T", @"D", @"B", @"X", @"K", @"P", @"W", @"C", @"V", @"J", @"G"];
}

+ (NSArray<NSString *> *)smartVowelKeys {
  return @[@"ruu", @"aee", @"Aa", @"AA", @"aa", @"ii", @"uu", @"UU", @"Uu", @"ee", @"ai", @"oo", @"OO", @"Oo", @"au", @"ou", @"Ru", @"ru",
