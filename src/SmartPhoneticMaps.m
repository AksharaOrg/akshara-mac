...
+ (NSDictionary<NSString *, NSString *> *)smartConsonants {
  ...
  dispatch_once(&onceToken, ^{
    map = @{
      ...
      @"ch": @"ච", @"j": @"ජ",
      @"t": @"ට", @"d": @"ඩ",
      @"tha": @"ත", @"th": @"ත", // Wait, user said "ත - tha". I'll put th and tha? No, just keys.
      @"dha": @"ද", @"q": @"ද", @"dh": @"ද",
      @"n": @"න", @"Na": @"ණ", @"N": @"ණ",
      @"p": @"ප", @"b": @"බ",
      @"m": @"ම",
      @"y": @"ය", @"r": @"ර", @"l": @"ල", @"La": @"ළ", @"L": @"ළ",
      @"w": @"ව", @"va": @"ව", @"v": @"ව",
      @"s": @"ස", @"sh": @"ශ", @"Sa": @"ෂ", @"S": @"ෂ", @"Sha": @"ෂ",
      @"ha": @"හ", @"h": @"හ",
      @"fa": @"ෆ", @"f": @"ෆ",
      @"kh": @"ඛ", @"gh": @"ඝ",
      @"chh": @"ඡ",
...
+ (NSArray<NSString *> *)smartConsonantKeys {
  return @[@"chh", @"thh", @"dhh", @"zdh", @"Sha",
           @"ch", @"th", @"dh", @"sh", @"kh", @"gh", @"ph", @"bh",
           @"zg", @"zj", @"zd", @"zq", @"zk", @"zh",
           @"Na", @"La", @"va", @"Sa", @"ha", @"fa", @"Ta", @"Da", @"dha",
